      ...
      <SidebarHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-lg">
            <Image src={logo} alt="HeyFuns" className="h-6 w-auto opacity-80" width={240} height={240} />
            <div className="text-lg font-bold">HeyFuns</div>
          </div>
          <Link href="https://github.com/iheytang/HeyFuns" target="_blank" rel="noopener noreferrer">
